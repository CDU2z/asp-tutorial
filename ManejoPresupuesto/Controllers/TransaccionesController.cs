...
namespace ManejoPresupuesto.Controllers
{
    public class TransaccionesController : Controller
    {
        ...
        public async Task<IActionResult> Mensual(int año)
        {
            ...
            for (int mes = 1; mes <= 12; mes++)
            {
                ...
                if (transaccion is null)
                    transaccionesAgrupadas.Add(new ResultadoObtenerPorMes() { Mes = mes, FechaReferencia = fechaReferencia });
                else
        ...
        public async Task<FileResult> ExportarExcelTodo()
        {
            ...
            var nombreArchivo = $"Manejo Presupuestos - {DateTime.Today:dd-MM-yyyy}.xlsx";
            return GenerarExcel(nombreArchivo, transacciones);
        }
        ...
        public async Task<IActionResult> Editar(TransaccionActualizacionViewModel modelo)
        {
            ...
            return string.IsNullOrEmpty(modelo.UrlRetorno) ? RedirectToAction("Index") : LocalRedirect(modelo.UrlRetorno);
        }
        ...
        public async Task<IActionResult> Borrar(int id, string urlRetorno = null)
        {
            ...
            return string.IsNullOrEmpty(urlRetorno) ? RedirectToAction("Index") : LocalRedirect(urlRetorno);
        }
